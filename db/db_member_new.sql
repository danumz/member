...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Agu 2020 pada 14.29
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `golongan_member` (
...
`id_member` int(11) NOT NULL,
  ...
  `id_golongan_member` int(11) NOT NULL
...
INSERT INTO `tb_member` (`id_member`, `id_user_member`, `tanggal_awal`, `tanggal_akhir`, `id_golongan_member`) VALUES
(11, 14, '2020-08-22', '2020-09-05', 2);
...
(16, 'ulum', '827ccb0eea8a706c4c34a16891f84e7b', 'nasrul ulum', 'montor', '2002-04-04', '09876543', 'demak', 'H2180PN', 2, 'baru@gmail.com', 'nonaktif', '2020-05-03'),
...
(22, 'fiqoh', '827ccb0eea8a706c4c34a16891f84e7b', 'fiqoh nimah', 'mobil', '2000-05-07', '09767542569786', 'semarang', 'H7771PP', 4, 'coba@gmail.com', 'nonaktif', '2020-05-05');
...
--
ALTER TABLE `tb_user`
 ADD PRIMARY KEY (`id_user_member`), ADD KEY `id_golongan_darah` (`id_golongan_member`);
